...
class MyFirebase():
    API_KEY = "AIzaSyA7wyOzN27I5JwvNe4E0cIVehkPCkzZmLg"
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get("https://aplicativovendashash-2026e-default-rtdb.firebaseio.com/proximo_id_vendedor.json")
            id_vendedor = req_id.json()

            link = f"https://aplicativovendashash-2026e-default-rtdb.firebaseio.com/{local_id}.json"
            ...
            requests.patch("https://aplicativovendashash-2026e-default-rtdb.firebaseio.com/.json", data=info_id_vendedor)
